...
<html
  ...
  <head>
    ...
    <title>VERSION 4 Dashboard | NCO Helpdesk</title>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('home') }}" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2">V4 NCO Helpdesk</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="{{ route('roles.allrole') }}" class="menu-link">
                ...
                <div data-i18n="Basic">User Groups</div>
              </a>
            </li>
            <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="{{ route('reportingpersons.allreportingperson') }}" class="menu-link">
                ...
                <div data-i18n="Basic">Reporting Person</div>
              </a>
            </li>
            <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="{{ route('knowledgebases.allknowledgebase') }}" class="menu-link">
                ...
                <div data-i18n="Basic">Knowledge Base</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="{{ route('home') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-file"></i>
                <div data-i18n="Tables">Last 30 Days [x]</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{ route('home') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-file"></i>
                <div data-i18n="Tables">New Tickets [x]</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{ route('home') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-file"></i>
                <div data-i18n="Tables">Closed [x]</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{ route('home') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-file"></i>
                <div data-i18n="Tables">Overdue [x]</div>
              </a>
            </li>
          </ul>
        </aside>
